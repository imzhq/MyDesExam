...
/**
 * Created by nickname on 2018/6/30.
 */
public class MacEcbUtils {
	...
	// S盒代替
	// 输入输出皆为部分数组，因此带偏移量
	private static void Sbox(int[] iInput, int iOffI, int[] iOutput, int iOffO, int[] iSPM) {
		int iRow = iInput[iOffI] * 2 + iInput[iOffI + 5]; // S盒中的行号
		int iCol = iInput[iOffI + 1] * 8 + iInput[iOffI + 2] * 4 + iInput[iOffI + 3] * 2 + iInput[iOffI + 4];
		// S盒中的列号
	...
	public static void main(String[] args) {
		String key = "1C4A029B156E257A80572F6B4692CBCB";
		String value = "33313345333133453334334133303034";
		String result = encryptDES(key, value);
		System.out.println(result);
		String disResult = discryption(result, key);
