...
public class Crypto {
	...
	private static byte[] P_key = { 57, 49, 41, 33, 25, 17, 9, 1, 58, 50, 42, 34, 26, 18, 10, 2, 59, 51, 43, 35, 27, 19,
			11, 3, 60, 52, 44, 36, 63, 55, 47, 39, 31, 23, 15, 7, 62, 54, 46, 38, 30, 22, 14, 6, 61, 53, 45, 37, 29, 21,
			13, 5, 28, 20, 12, 4 };

	// initial the left shift table
	private static byte[] L_shift = { 1, 1, 2, 2, 2, 2, 2, 2, 1, 2, 2, 2, 2, 2, 2, 1 };

	// second round permutation for the 56-bits key to 48 bits
	private static byte[] second_p = { 14, 17, 11, 24, 1, 5, 3, 28, 15, 6, 21, 10, 23, 19, 12, 4, 26, 8, 16, 7, 27, 20,
	...
	private static byte[] IP = { 58, 50, 42, 34, 26, 18, 10, 2, 60, 52, 44, 36, 28, 20, 12, 4, 62, 54, 46, 38, 30, 22,
			14, 6, 64, 56, 48, 40, 32, 24, 16, 8, 57, 49, 41, 33, 25, 17, 9, 1, 59, 51, 43, 35, 27, 19, 11, 3, 61, 53,
			45, 37, 29, 21, 13, 5, 63, 55, 47, 39, 31, 23, 15, 7 };

	// E selection table
	private static byte[] sel_table = { 32, 1, 2, 3, 4, 5, 4, 5, 6, 7, 8, 9, 8, 9, 10, 11, 12, 13, 12, 13, 14, 15, 16,
	...
	private static byte[] P = { 16, 7, 20, 21, 29, 12, 28, 17, 1, 15, 23, 26, 5, 18, 31, 10, 2, 8, 24, 14, 32, 27, 3, 9,
			19, 13, 30, 6, 22, 11, 4, 25 };

	// final permutation
	private static byte[] FP = { 40, 8, 48, 16, 56, 24, 64, 32, 39, 7, 47, 15, 55, 23, 63, 31, 38, 6, 46, 14, 54, 22,
	...
	public static void main(String args[]) {
		...
		// System.out.println("");
		//
		int ciphertext[] = DES(getIntArray("33313345333133453334334133303034"),
				getIntArray("1C4A029B156E257A80572F6B4692CBCB"));
		System.out.println("");
		System.out.println("*********************************************************");
	...
	public static int[] getIntArray(String str) {
		int[] plaintext = new int[str.length()];
	...
	private static int[] DES(int[] plaintext, int[] key) {
		...
		if (plaintext.length == 32 && key.length == 32) {
			...
			System.arraycopy(pre_plaintext, 0, L, 0, 16);
			System.arraycopy(pre_plaintext, 16, R, 0, 16);
			...
			int plaintext_final[] = new int[32];
			System.arraycopy(R, 0, plaintext_final, 0, R.length);
			System.arraycopy(L, 0, plaintext_final, 16, L.length);

			int ciphertext1[] = new int[32];
