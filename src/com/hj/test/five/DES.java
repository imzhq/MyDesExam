...
public class DES {
	...
	private static int[] invIP = { 40, 8, 48, 16, 56, 24, 64, 32, 39, 7, 47, 15, 55, 23, 63, 31, 38, 6, 46, 14, 54, 22,
	...
	private static int[] leftShift = { 1, 1, 2, 2, 2, 2, 2, 2, 1, 2, 2, 2, 2, 2, 2, 1 };
	// expansion permutation for feistel function
	private static int[] expansionTable = { 32, 1, 2, 3, 4, 5, 4, 5, 6, 7, 8, 9, 8, 9, 10, 11, 12, 13, 12, 13, 14, 15,
	...
	public static byte[] encrypt(byte[] data, byte[] key) {
		paddingLength = 0;
		int i;
		// hitung panjang string plaintext dan tambahkan byte 0 jika panjangnya tidak
		// kelipatan 8
		if (data.length % 8 > 0)
