...
public final class DesUtils {
	...
	/**
	 * 本项目用于生成外部设备认证码和校验卡认证码（javacard GP规范 SCP02安全通道）（cardCryptogram） B.1.2.1 Full
	 * Triple DES MAC The full triple DES MAC is as defined in [ISO 9797-1] as MAC
	 * Algorithm 1 with output transformation 3, without truncation, and with triple
	 * DES taking the place of the block cipher.
	 * 
	 * @param content
	 *            待加密数据
	 * @param key
