...
public class DESS {
	...
	public static void main(String[] args) throws Exception {
		...
		String masterKey = "1C4A029B156E257A80572F6B4692CBCB";

		// 数据

		String data = "3331334533313345";
		System.out.println(DES_1(data, masterKey, 0));

		System.out.println(DES_3(data, masterKey, 0));

		String dpk = getDPK("1111111111111111", "1111111111111111", "12345678901234567890123456789012");
